...
function onloadCallback() {
    ...
    for (i = 0; i < a.length; i++) recaptchaIds[i] = grecaptcha.render(a[i].id, {
        //sitekey: "6LegUjYUAAAAAOIptlp4CQGTVIFH6APqe8AhCIVs" //original
        sitekey: "6LeTxTcUAAAAAA0pHcw86RYdF5N4_-sQcaYUD8Pc" // halcyon.user
    });
}
...
function nextStep1() {
    isValidEthAddress($("#addressInput").val()) ? ($("#eth-address-msg").text(""), $("#eth-address").fadeOut("slow", function() {
    ...
    })) : ($("#errModal").modal("show"), $(".modal-body").text("Invalid ETH wallet address").css("color", "#C40404"), $("#eth-address-msg").text("Invalid ETH wallet address").css("color", "#C40404"));
}
